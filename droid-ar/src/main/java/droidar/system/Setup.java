package droidar.system;

import droidar.gamelogic.FeedbackReports;
...
import droidar.gl.GLRenderer;
import droidar.gl.LightSource;
import droidar.gl.ObjectPicker;
import droidar.gl.textures.TextureManager;
import droidar.gui.GuiSetup;
import droidar.gui.InfoScreen;
import droidar.gui.InfoScreenSettings;
import droidar.gui.simpleUI.EditItem;
import droidar.gui.simpleUI.ModifierGroup;
...
import droidar.gui.simpleUI.modifiers.Headline;
import droidar.gui.simpleUI.modifiers.InfoText;
import droidar.listeners.SetupListener;
...
import droidar.commands.CommandGroup;
import droidar.commands.system.CommandDeviceVibrate;
...
public abstract class Setup {
	...
	public void run(Activity target) {
		...
		// set sensorinput droidar.actions:
	 ...
	 * the AR rotation and translation in a correct way. Therefore two droidar.actions
			...
			public boolean execute() {
				SimpleUIv1.showInfoScreen(currentActivity, new EditItem() {
					...
					public void customizeScreen(ModifierGroup group,
							Object message) {
						group.addModifier(new Headline(
								R.drawable.logo, "DroidAR"));
						group.addModifier(new InfoText(
