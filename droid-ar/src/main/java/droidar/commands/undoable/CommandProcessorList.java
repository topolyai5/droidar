package droidar.commands.undoable;
...
public class CommandProcessorList extends ArrayList<UndoableCommand> {
	...
	public boolean add(UndoableCommand object) {
		// if there are redo droidar.commands after the current pos then remove these
	...
	public boolean undo() {
		// dont delete the droidar.commands that are undone, just move myPos curser and
		// undo them:
	...
	/**
	 * @param x
	 *            the number of droidar.commands to be removed
	 */
